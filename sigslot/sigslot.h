...
namespace internal {
    ...
    struct signal_type
    {
        typedef signal<SIGSLOT_DEFAULT_MT_POLICY, args...> sig;
        typedef repeater<SIGSLOT_DEFAULT_MT_POLICY, args...> rep;
    };
